...
use fide_proxy::dispatch::Dispatcher;
use fide_rpc::{
...
impl CoreHandler for Proxy {
    fn handle_notification(&mut self, rpc: fide_rpc::core::CoreNotification) {
    ...
    fn handle_request(
        &mut self,
        _id: fide_rpc::RequestId,
        _rpc: fide_rpc::core::CoreRequest,
    ) {
    }
}
