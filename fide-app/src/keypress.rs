...
use crate::{
    command::{CommandExecuted, CommandKind, FIDECommand, fide_internal_commands},
    config::FIDEConfig,
    keypress::{
...
pub struct KeyPressData {
    ...
    pub commands: Rc<IndexMap<String, FIDECommand>>,
    ...
    pub commands_without_keymap: Rc<Vec<FIDECommand>>,
}

impl KeyPressData {
    pub fn new(cx: Scope, config: &FIDEConfig) -> Self {
        ...
        let mut keypress = Self {
            ...
            commands: Rc::new(fide_internal_commands()),
    ...
    pub fn update_keymaps(&mut self, config: &FIDEConfig) {
