...
pub struct TabsInfo {
    ...
    pub workspaces: Vec<FIDEWorkspace>,
}
...
/// resized using your window manager. Normally FIDE has only one
...
impl WindowData {
    pub fn new(
        ...
        let cx = Scope::new();
        let config =
            FIDEConfig::load(&FIDEWorkspace::default(), &[], &extra_plugin_paths);
    ...
    pub fn info(&self) -> WindowInfo {
        let workspaces: Vec<FIDEWorkspace> = self
            .window_tabs
            .get_untracked()
            .iter()
