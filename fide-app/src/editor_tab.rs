    ...
    pub fn view_info(
        ...
        match self.clone() {
            EditorTabChild::Editor(editor_id) => create_memo(move |_| {
                ...
                let (icon, color, name, confirmed, is_pristine) = match path {
                    ...
                    None => (
                        ...
                        Some(config.color(FIDEColor::LAPCE_ICON_ACTIVE)),
                        "local".to_string(),
            ...
            EditorTabChild::Settings(_) => create_memo(move |_| {
                let config = config.get();
                EditorTabChildViewInfo {
                    icon: config.ui_svg(FIDEIcons::SETTINGS),
                    color: Some(config.color(FIDEColor::LAPCE_ICON_ACTIVE)),
            ...
            EditorTabChild::ThemeColorSettings(_) => create_memo(move |_| {
                let config = config.get();
                EditorTabChildViewInfo {
                    icon: config.ui_svg(FIDEIcons::SYMBOL_COLOR),
                    color: Some(config.color(FIDEColor::LAPCE_ICON_ACTIVE)),
            ...
            EditorTabChild::Keymap(_) => create_memo(move |_| {
                let config = config.get();
                EditorTabChildViewInfo {
                    icon: config.ui_svg(FIDEIcons::KEYBOARD),
                    color: Some(config.color(FIDEColor::LAPCE_ICON_ACTIVE)),
            ...
            EditorTabChild::Volt(_, id) => create_memo(move |_| {
                ...
                EditorTabChildViewInfo {
                    icon: config.ui_svg(FIDEIcons::EXTENSIONS),
                    color: Some(config.color(FIDEColor::LAPCE_ICON_ACTIVE)),
                    name: display_name,
                    path: None,
                    confirmed: None,
