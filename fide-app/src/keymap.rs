...
pub struct KeymapPicker {
    cmd: RwSignal<Option<FIDECommand>>,
...
pub fn keymap_view(editors: Editors, common: Rc<CommonData>) -> impl View {
    ...
    let items = move || {
        ...
        let mut items = keypress
            ...
            .collect::<im::Vector<(FIDECommand, Option<KeyMap>)>>();
        ...
        items
            .into_iter()
            .enumerate()
            .collect::<im::Vector<(usize, (FIDECommand, Option<KeyMap>))>>()
    };

    let view_fn =
        move |(i, (cmd, keymap)): (usize, (FIDECommand, Option<KeyMap>))| {
            ...
            .style(move |s| {
                ...
                s.items_center()
                    ...
                    .width_pct(100.0)
                    .apply_if(i % 2 > 0, |s| {
                        s.background(config.color(FIDEColor::EDITOR_CURRENT_LINE))
                    })
                    .border_bottom(1.0)
    ...
    stack((
        ...
        .style(move |s| {
            ...
            s.font_bold()
                ...
                .border_bottom(1.0)
                .border_color(config.color(FIDEColor::LAPCE_BORDER))
                .background(config.color(FIDEColor::EDITOR_CURRENT_LINE))
        }),
        container(
            scroll(
                virtual_stack(
