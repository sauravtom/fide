...
pub struct FIDEColor {}

impl FIDEColor {
    pub const LAPCE_WARN: &'static str = "fide.warn";
    pub const LAPCE_ERROR: &'static str = "fide.error";
    pub const LAPCE_DROPDOWN_SHADOW: &'static str = "fide.dropdown_shadow";
    pub const LAPCE_BORDER: &'static str = "fide.border";
    pub const LAPCE_SCROLL_BAR: &'static str = "fide.scroll_bar";

    pub const LAPCE_BUTTON_PRIMARY_BACKGROUND: &'static str =
        "fide.button.primary.background";
    pub const LAPCE_BUTTON_PRIMARY_FOREGROUND: &'static str =
        "fide.button.primary.foreground";

    pub const LAPCE_TAB_ACTIVE_BACKGROUND: &'static str =
        "fide.tab.active.background";
    pub const LAPCE_TAB_ACTIVE_FOREGROUND: &'static str =
        "fide.tab.active.foreground";
    pub const LAPCE_TAB_ACTIVE_UNDERLINE: &'static str =
        "fide.tab.active.underline";

    pub const LAPCE_TAB_INACTIVE_BACKGROUND: &'static str =
        "fide.tab.inactive.background";
    pub const LAPCE_TAB_INACTIVE_FOREGROUND: &'static str =
        "fide.tab.inactive.foreground";
    pub const LAPCE_TAB_INACTIVE_UNDERLINE: &'static str =
        "fide.tab.inactive.underline";

    pub const LAPCE_TAB_SEPARATOR: &'static str = "fide.tab.separator";

    pub const LAPCE_ICON_ACTIVE: &'static str = "fide.icon.active";
    pub const LAPCE_ICON_INACTIVE: &'static str = "fide.icon.inactive";

    pub const LAPCE_REMOTE_ICON: &'static str = "fide.remote.icon";
    pub const LAPCE_REMOTE_LOCAL: &'static str = "fide.remote.local";
    pub const LAPCE_REMOTE_CONNECTED: &'static str = "fide.remote.connected";
    pub const LAPCE_REMOTE_CONNECTING: &'static str = "fide.remote.connecting";
    pub const LAPCE_REMOTE_DISCONNECTED: &'static str = "fide.remote.disconnected";

    pub const LAPCE_PLUGIN_NAME: &'static str = "fide.plugin.name";
    pub const LAPCE_PLUGIN_DESCRIPTION: &'static str = "fide.plugin.description";
    pub const LAPCE_PLUGIN_AUTHOR: &'static str = "fide.plugin.author";
