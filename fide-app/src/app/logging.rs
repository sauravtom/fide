...
pub(super) fn logging() -> (Handle<Targets>, Option<WorkerGuard>) {
    ...
    let log_file_filter_targets = filter::Targets::new()
        .with_target("fide_app", LevelFilter::DEBUG)
        .with_target("fide_proxy", LevelFilter::DEBUG)
        .with_target("fide_core", LevelFilter::DEBUG)
