                ...
                stack((
                    {
                        let svg_str = match (&p.mode, p.stopped) {
                            (RunDebugMode::Run, false) => FIDEIcons::START,
                            (RunDebugMode::Run, true) => FIDEIcons::RUN_ERRORS,
                            (RunDebugMode::Debug, false) => FIDEIcons::DEBUG,
                            (RunDebugMode::Debug, true) => {
                                FIDEIcons::DEBUG_DISCONNECT
                            }
                        };
                ...
                .style(move |s| {
                    ...
                    s.padding_vert(6.0)
                        ...
                        .apply_if(is_active(), |s| {
                            s.background(
                                config.color(FIDEColor::PANEL_CURRENT_BACKGROUND),
                            )
                        })
                        .hover(|s| {
                    ...
                    stack((
                        svg(move || {
                            ...
                            let svg_str = match node.expanded {
                                true => FIDEIcons::ITEM_OPENED,
                                false => FIDEIcons::ITEM_CLOSED,
                            };
                        ...
                        s.items_center()
                            ...
                            .hover(|s| {
                                s.apply_if(reference > 0, |s| {
                                    s.background(
                                        config.get().color(
                                            FIDEColor::PANEL_HOVERED_BACKGROUND,
                                        ),
                                    )
                                })
                            })
                ...
                .style(move |s| {
                    ...
                    s.padding_left(20.0)
                        ...
                        .apply_if(!has_source, |s| {
                            s.color(config.color(FIDEColor::EDITOR_DIM))
                        })
                        .hover(|s| {
                            s.background(
                                config.color(FIDEColor::PANEL_HOVERED_BACKGROUND),
