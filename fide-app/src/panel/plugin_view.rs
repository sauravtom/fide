    ...
    let install_button =
        move |id: VoltID, info: RwSignal<VoltInfo>, installing: RwSignal<bool>| {
            ...
            .style(move |s| {
                ...
                s.color(config.color(FIDEColor::LAPCE_BUTTON_PRIMARY_FOREGROUND))
                    .background(
                        config.color(FIDEColor::LAPCE_BUTTON_PRIMARY_BACKGROUND),
                    )
                    .margin_left(6.0)
                    .padding_horiz(6.0)
                    .border_radius(6.0)
                    ...
                    .disabled(|s| s.background(config.color(FIDEColor::EDITOR_DIM)))
            })
        };
