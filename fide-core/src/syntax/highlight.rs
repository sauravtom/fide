...
use crate::{language::FIDELanguage, style::SCOPES};

thread_local! {
    static HIGHLIGHT_CONFIGS: RefCell<HashMap<FIDELanguage, Result<Arc<HighlightConfiguration>, HighlightIssue>>> = Default::default();
}
